...
<script type="text/javascript">
     $(function () {
         ...
         $.ajax({
			  type:"post",
             url:"${ctx}/menu/loadAllModule.jspx",
              dataType:"json",
             success:function(result){
                 $.each(result,function(){
					 if (this.id.length!=12){
					 //d.add("节点ID","父级节点ID","节点名称","跳转的地址","标题","跳转目的地显示的位置")
					 d.add(this.id,this.pid,this.name,this.id.length==4?"${ctx}/menu/selectMenu.jspx":"${ctx}/menu/getModulesByPcode.jspx?&code="+this.id,this.name,"rightFrame");
					 }
                 });
    ...
    <body class="easyui-layout" style="width:100%;height:100%;">
            ...
            <div data-options="region:'center'" title="模块菜单"  >
			     <!-- 展示当前模块下的子模块  -->
			     <iframe src="${ctx}/menu/selectMenu.jspx" frameborder="0" id="sonModules" name="rightFrame" width="100%" height="100%" ></iframe>
			</div>
	</body>
</html>
