...
<body style="background: #F5FAFA;">
	<center>
		<form id="updateUserForm" action="${ctx}/user/updateUserSave.jspx" method="post" style="padding: 10px;">
			<!-- 当前用户的useId -->
			...
			<table class="table-condensed">
				<tbody>
					<tr>
						...
						<td><input type="text" id="name" name="name" value="${user.name}" class="form-control" placeholder="请输入您的电子邮件"></td>
					</tr>
					<tr>
						<td><label>密码:</label></td>
						<td><input type="password" id="password" name="passWord" value="${user.passWord}" class="form-control" placeholder="请输入您的密码"></td>
						<td><label>确认密码:</label></td>
						<td><input type="password" id="repwd" name="repwd" value="${user.passWord}" class="form-control" placeholder="请输入您的确认密码"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><select id="jobSelect" name="job.code" class="btn btn-default" >
							<option  value="${user.job.code}">${user.job.name}</option>
						</select>
						</td>
					...
					<tr>
						...
						<td><select name="question" class="btn btn-default" id="question">
