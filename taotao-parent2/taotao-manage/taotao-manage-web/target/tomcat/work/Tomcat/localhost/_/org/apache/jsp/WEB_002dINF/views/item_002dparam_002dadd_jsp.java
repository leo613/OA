 ...
 * Generated at: 2020-06-30 06:43:12 UTC
...
public final class item_002dparam_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\tfun:function(node){ //自定义回调函数\r\n");
      ...
      out.write("                          $.messager.alert(\"提示\", \"该类目已经添加，请选择其他类目。\", undefined, function(){\r\n");
      out.write("                              $(\"#itemParamAddTable .selectItemCat\").click(); //重新点击选择类目\r\n");
      out.write("                          });\r\n");
      out.write("                      },\r\n");
      ...
      out.write("                          $.messager.alert('提示','error');\r\n");
      out.write("                      }\r\n");
      out.write("                  }\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t});\r\n");
      ...
      out.write("\t\t\t//i:选择器的index位置,e:当前的元素\r\n");
      out.write("\t\t\tgroups.each(function(i,e){\r\n");
      out.write("\t\t\t\tvar p = $(e).parentsUntil(\"ul\").parent().find(\"[name=param]\"); //查找父类name为：param\r\n");
      out.write("\t\t\t\tvar _ps = [];\r\n");
      out.write("\t\t\t\tp.each(function(_i,_e){\r\n");
      out.write("\t\t\t\t\tvar _val = $(_e).siblings(\"input\").val(); //查找input 同胞元素\r\n");
      out.write("\t\t\t\t\tif($.trim(_val).length>0){\r\n");
      out.write("\t\t\t\t\t\t_ps.push(_val);\t\t//查找的元素放入数组\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
