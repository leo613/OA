 ...
 * Generated at: 2020-07-03 08:36:56 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tonContextMenu: function(e,node){ //右键菜单时间\r\n");
      out.write("            e.preventDefault(); //阻止默认事件的执行\r\n");
      out.write("            $(this).tree('select',node.target); //选中当前的节点\r\n");
      out.write("            $('#contentCategoryMenu').menu('show',{ //显示菜单,并且指定显示位置\r\n");
      out.write("                left: e.pageX,\r\n");
      out.write("                top: e.pageY\r\n");
      out.write("            });\r\n");
      out.write("        },\r\n");
      out.write("        onAfterEdit : function(node){//按下回车,完成编辑事件\r\n");
      ...
      out.write("            data: [{\r\n");
      out.write("                text: '新建分类',  //name\r\n");
      out.write("                id : 0,\r\n");
      out.write("                parentId : node.id //parentId\r\n");
      out.write("            }]\r\n");
      out.write("        }); \r\n");
      out.write("\t\tvar _node = tree.tree('find',0);  //查找到新添加的节点\r\n");
      out.write("\t\ttree.tree(\"select\",_node.target).tree('beginEdit',_node.target); //选中该节点并开始编辑\r\n");
